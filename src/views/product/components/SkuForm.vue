...
<script>
  export default {
    ...
    methods: {
      ...
      // 收集sku图片列表的回调
      // sku的图片列表是从spu的图片列表当中选择来的，选择了几个，那么就由选择的这几个组成数组变为sku的图片列表
      ...
      async save() {
        ...
        // 2.2.4 把整理好的skuImageList放到skuForm当中
